 ...
 */
async function getHarBuilderInstance(driver, browsingContextIds) {
  let instance = new HarBuilder(driver, browsingContextIds)
  return instance
}

/**
 * API
 * @type {function(*, *): Promise<HarBuilder>}
 */
module.exports = getHarBuilderInstance
